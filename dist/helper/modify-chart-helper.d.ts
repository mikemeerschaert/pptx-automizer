...
import { ChartAxisRange, ChartData, ChartDataLabelAttributes, ChartElementCoordinateShares } from '../types/chart-types';
...
export default class ModifyChartHelper {
     ...
     *
     */
    static setDataLabelAttributes: (dataLabel: ChartDataLabelAttributes) => ChartModificationCallback;
}
